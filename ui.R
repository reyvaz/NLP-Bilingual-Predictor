# Contains the shinyUI (interface) portion of the shiny App for the English-
# Spanish word predictor
# 
# Created on 2017 by Reynaldo Vazquez for the purpose of developing an English-
# Spanish word predictor with language auto-detect.
# 
...
shinyUI(
  navbarPage(
      theme = shinytheme("cosmo"), inverse =FALSE, "word predictor", 
      tabPanel("predictor",
        ...
        fluidPage(
          ...
          column(8, align="left", offset = 2, style = "padding:1.3em;",
                 useShinyjs(),
                 actionButton("optionMenu", "show options", width = "24.7%",
                              style='padding:0px;min-width: 9em; 
                              color:white;height:27px; 
                              border:1px solid #404040;'),
                 hidden(actionButton("topHelp", "hide help", width ="24.7%",
                              style='padding:0px;min-width: 9em; 
                              color:white; height:27px; 
                              border:1px solid #404040;')),
                 hidden(actionButton("currents", "next-words only", 
                                     width="24.6%",
                              style='padding:0px;min-width: 9em; 
                              color:white; height:27px; 
                              border:1px solid #404040;')),
                 hidden(actionButton("preds","less next-words", width = "24.6%",
                              style='padding:0px;min-width: 9em; 
                              color:white; height:27px; 
                              border:1px solid #404040;'))
                ),
          column(8, align="left", offset = 2, style = "padding:1.5em;",
                 h1("en-es word predictor", style='color: #e6e6e6'),
                 p("with language auto-detection (beta)", 
                   style='color: #e6e6e6'),
                 br()),
          ...
          column(8, align="center", offset = 2,
                 br(),
                 actionButton("reset", "clear all", width = "90",
                              style='padding:0px;min-width: 7em; 
                              color:#a6a6a6;
                              height:25px; border-color:#404040'),
                             useShinyjs(),
                 actionButton("centerHelp","hide help",width="90",
                              style='padding:0px;min-width: 7em;
                              color:#a6a6a6;
                              height:25px; border-color:#404040'),
                 br(),br()), 
          column(8, align="center", offset = 2,
                ...
                div(HTML("<html><head><style>
                   ...
                   <a href=\"https://rvaz.shinyapps.io/es_predictor/\" 
                    style= \"color:black\">Spanish&nbspapp</a>
                       </div>
                       </div>
                       </body></html>")
              )
      ...
      tabPanel("information", fluidPage(
        fluidPage(
          ...
          div(id = "english",
             ...
             column(10, align="justify", offset = 1,
                    ...
                    p("The app takes English or Spanish text as input and 
                        automatically:", style="color: white"), 
                    tags$ol(
                        tags$li("Detects language", 
                                style="color: white"), 
                        tags$li("Provides suggestions to complete the word being 
                                typed", style="color: white"), 
                        tags$li("Provides suggestions for the next word", 
                                style="color: white")
                        ),
                    ...
                    p("Customizations", 
                      style="color: white"), 
                    tags$ol(
                        tags$li("Click on the \"show options\" button to display 
                                options ", style="color: white"), 
                        tags$li("Click on the \"hide help\" button to hide 
                                instructions, click again to undo", 
                                style="color: white"),
                        tags$li("Click on the \"next-words only\" 
                                button to hide current-word suggestions, 
                                click again to undo", style="color: white"),
                        tags$li("Click on the \"less next-words\" button  
             ...
             column(10, align="justify", offset = 1,
                    ...
                    p("During the process just described, the program performs 
                      multiple language checks. From looking for signals such 
                      as special characters unique to a language, to 
                      self-evaluations of success. ", style="color: white"), 
             ...
             column(10, align="justify", offset = 1,
                    ...
                    p("To build the predictor the following corpora were used,", 
                      style="color: white"), 
                    tags$ol(
                      tags$li("Three English corpora from SwiftKey containing 
                              publicly available news, personal blogs, and 
                              twitter posts", style="color: white"), 
                      tags$li("A partial English Wikipedia dump containing 
                              updated articles. Downloaded on Aug 18, 2017 ", 
                              style="color: white"), 
                      tags$li("A collection of recent, popular, and trending 
                              topics Twitter posts in English from Aug 28-30, 
                              2017 ", style="color: white"), 
                      tags$li("The entire May 9, 2017 Memory Alpha Encyclopedia 
                              dump, English version. Downloaded on Aug 28, 
                              2017", style="color: white"),
                    ...
                    elements not related to the corpus, remove profanity, 
                    ...
                    p("A goal during preprocessing was to keep it minimal in  
                      ...
                      possible about how English and Spanish are typed,  
                      including grammar, common misspellings, contractions,  
                      abbreviations, acronyms, and slang.", 
                      style="color: white"), 
                    p("The final corpora used for the predictor contain ~365.5 
                      million words in a combined ~2.5 GiB of uncompressed 
             ...
             column(10, align="justify", offset = 1,
                    ...
                    p("To learn more,
                      visit the following links,", style="color: white"),
          ...
          hidden(div(id = "espanol",
             ...
             column(10, align="justify", offset = 1,
                    ...
                    p("La aplicación admite texto en inglés o español y 
                        automáticamente:", style="color: white"), 
                    tags$ol(
                        tags$li("Detecta el idioma", style="color: white"), 
                        tags$li("Provee sugerencias para completar la palabra en 
                                curso", style="color: white"), 
                        tags$li("Provee sugerencias para la siguiente palabra", 
                                style="color: white")
                    ),
                    ...
                    tags$ol(
                        tags$li("Presiona en el botón \"show options\" para 
                                ver las opciones", style="color: white"),
                        tags$li("Presiona en \"hide help\" para ocultar 
                                las instrucciones. Repite para 
                                volverlas a mostrar", 
                                style="color: white"),
                        tags$li("Presiona \"next-words only\" para ocultar
                                las sugerencias de la palabra en curso.
                                Repite para nuevamente 
                                mostrarlas",
                                style="color: white"),
                        tags$li("Presiona “less next-words” para mostrar 
             ...
             column(10, align="justify", offset = 1,
                    ...
                    p("Entre los pasos descritos, el programa hace varias tareas
                      de verificación de idioma. Desde buscar señales como 
                      símbolos o caracteres únicos a uno u otro idioma, hasta 
                      autoevaluarse el éxito obtenido asumiendo algún idioma", 
                      style="color: white"), 
             ...
             column(10, align="justify", offset = 1,
                    ...
                    tags$ol(
                        tags$li("Tres archivos de SwifKey en inglés que 
                                contienen noticias, blogs personales y estados 
                                de twitter, todos públicamente disponibles",
                                style="color: white"), 
                        tags$li("Artículos actualizados de Wikipedia versión  
                                inglés descargados el 18 de agosto del 
                                2017", style="color: white"), 
                        tags$li("Una colección de estados populares, recientes 
                                y trending de Twitter en inglés descargados 
                                entre el 28 y el 30 de agosto del 2017",
                                style="color: white"),
                        tags$li("El respaldo completo de Mayo 9, 2017 de la 
                                enciclopedia Memory Alpha en inglés. Descargado 
                  ...
                  p("El procesamiento se mantuvo intencionalmente al mínimo  
                     para así capturar los dos idiomas tal y como son comúnmente  
                     escritos, incluyendo gramática, errores ortográficos,  
                     abreviaciones, siglas, y jerga.", 
                     style="color: white"),
                  p("Los corpus procesados contienen ~365.5 millones de palabras 
                     en un espacio combinado de aproximadamente 2.5 GiB.", 
                     style="color: white"),
